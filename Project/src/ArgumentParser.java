...
public class ArgumentParser {
	...
	/**
	 * Determines whether the argument is a flag. Flags start with a dash "-" character, followed by at
	 * least one other non-digit character.
	 *
	...
	/**
	 * Returns the value to which the specified flag is mapped as a {@link String}, or null if there is
	 * no mapping.
	 *
	...
	/**
	 * Returns the value to which the specified flag is mapped as a {@link String}, or the default value
	 ...
	 * unable to retrieve this mapping (including being unable to convert the value to a {@link Path} or
	 * no value exists).
	 *
	...
	/**
	 * Returns the value the specified flag is mapped as a {@link Path}, or the default value if unable
	 * to retrieve this mapping (including being unable to convert the value to a {@link Path} or if no
	 * value exists).
	 *
	 * This method should not throw any exceptions!
	 *
